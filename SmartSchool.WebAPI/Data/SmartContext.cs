...
namespace SmartSchool.WebAPI.Data
{
    public class SmartContext : DbContext
    {
        ...
        {
            // Adding tables to the database with initial values
            ...
            builder.Entity<Curso>()
                .HasData(new List<Curso>{
                    ...
                    new Curso(2, "Sistemas da Informação"),
                    new Curso(3, "Ciência da Computação")
                });
                        
            builder.Entity<Disciplina>()
                .HasData(new List<Disciplina>{
                    // Aqui dizemos que Matématica está presente nos cursos Tecnologia da Informação e Ciência da Computação, e etc.
